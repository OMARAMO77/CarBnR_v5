...
@app_views.route('/cars/<car_id>/reviews', methods=['GET'],
                 strict_slashes=False)
@swag_from('documentation/reviews/get_reviews.yml', methods=['GET'])
def get_reviews(car_id):
    """
    Retrieves the list of all Review objects of a Car
    """
    ...
    reviews = [review.to_dict() for review in car.reviews]
...
@app_views.route('/cars/<car_id>/reviews', methods=['POST'],
                 strict_slashes=False)
@swag_from('documentation/reviews/post_reviews.yml', methods=['POST'])
def post_review(car_id):
    """
    Creates a Review
    """
    car = storage.get(Car, car_id)
...
def put_review(review_id):
    ...
    ignore = ['id', 'user_id', 'car_id', 'created_at', 'updated_at']
