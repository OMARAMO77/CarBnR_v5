...
class TestReview(unittest.TestCase):
    ...
    def test_car_id_attr(self):
        """Test Review has attr car_id, and it's an empty string"""
        review = Review()
        self.assertTrue(hasattr(review, "car_id"))
        if models.storage_t == 'db':
            self.assertEqual(review.car_id, None)
        else:
            self.assertEqual(review.car_id, "")
